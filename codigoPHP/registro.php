...
require_once "../config/confDBPDO.php";
    ...
    if($entradaOK){ 
        ...
        $miDB->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            ...
            $sqlUpdate = "Update T01_Usuario set T01_NumConexiones = :NumConexiones, T01_FechaHoraUltimaConexionAnterior=:FechaHoraUltimaConexionAnterior where T01_CodUsuario=:CodUsuario";
            $consultaUpdate = $miDB->prepare($sqlUpdate);//Preparamos la consulta
            $parametrosUpdate = [":NumConexiones" => (1),
                                 ":FechaHoraUltimaConexionAnterior" => ($oFechaHoraActual = new DateTime)->format('Y-m-d H:i:s'),
